// About: TypeScript basics with types, interfaces, classes, and functions.
// Run: Compile with `tsc` then run `node implementation_typescript_basics.js`,
// or use `npx ts-node implementation_typescript_basics.ts`.
